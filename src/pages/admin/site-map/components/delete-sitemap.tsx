...
const DeleteSiteMap = ({ id, open, setOpen, refetch }: IDeleteSiteMap): JSX.Element => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const errMgs = handleError(error);
      ...
      <AppModalView disableBoxClose open={open} setOpen={setOpen}>
        <Box className={classes.boxContent}>
          <Typography className={classes.titleHeader} variant="h3">
            Are you sure you want Remove this site map Url?
          </Typography>
